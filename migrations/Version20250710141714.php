 ...
 */
final class Version20250710141714 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__task AS SELECT id, user_ref_id, topic_idref_id, title, description FROM task');
        ...
        $this->addSql('INSERT INTO task (id, user_ref_id, topic_idref_id, title, description) SELECT id, user_ref_id, topic_idref_id, title, description FROM __temp__task');
